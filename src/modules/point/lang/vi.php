...
$lang->about_level_icon = 'Thư mục chứa Icon của cấp bậc có dạng "./common/point/icons/[level].gif" và cấp độ lớn nhất có thể khác với bộ Icon hiện tại. Vì vậy xin hãy cẩn thận.';
