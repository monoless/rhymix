...
$lang->about_level_icon = 'Ruta de íconos del nivel es ./common/point/icons/[level].gif y el nivel máximo puede ser diferente con el conjunto de íconos. Tenga cuidado';
