...
class LessCompiler {
	static public $VERSION = "v0.5.0-php8";
	...
	protected function newFormatter() {
		$className = "\\Rhymix\\Framework\\Parsers\\LessFormatterLessjs";
		if (!empty($this->formatterName)) {
			if (!is_string($this->formatterName))
				return $this->formatterName;
			
			$format = ucfirst($this->formatterName);
			$className = "\\Rhymix\\Framework\\Parsers\\LessFormatter{$format}";
		}
